...
```env
MODEL_NAME=microsoft/VibeVoice-Large
...
python -c "from huggingface_hub import snapshot_download; snapshot_download(repo_id='microsoft/VibeVoice-Large', local_dir='/app/models/VibeVoice-Large', cache_dir='/app/cache')"
```
